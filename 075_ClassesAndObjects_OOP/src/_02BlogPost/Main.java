...
//        asked to take his picture outside one of IBM’s New York City offices, he told me that he wasn’t really into the whole organizer profile thing.
        ...
        printBlogPost(LoremIpsum);
        printBlogPost(waitButWhy);
        printBlogPost(oneEngineer);
    }

    public static void printBlogPost (BlogPost name) {
        System.out.println(name.authorName);
        System.out.println(name.title);
        System.out.println(name.text);
        System.out.println(name.publicationDate);
        System.out.println();
    }
}
